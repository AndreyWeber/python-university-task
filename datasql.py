...
#         print(
#             "Client - ",
#             self.getClient().getSurname(),
#             " ",
#             self.getClient().getName(),
#             " ",
#             self.getClient().getSecname(),
#             "; ",
#             "KindService - ",
#             self.getKindService().getTypeService(),
#             "; ",
#             "finalprice - ",
#             self.finalprice(),
#         )
...
#         else:
#             self.appendItem(client(code, surname, name, secname, regular))
...
#         else:
#             self.appendItem(
#                 service(code, kindService, count, client, dateReception, dateReturn)
#             )

#     def newItem(self, kindService, count, client, dateReception, dateReturn):
#         self.appendItem(
#             service(
#                 self.getNewCode(), kindService, count, client, dateReception, dateReturn
#             )
#         )
...
#         if code in self.getCodes():
#             print("KindService with code %s already exists")
#         else:
#             self.appendItem(kindService(code, name, typeservice, price))
...
#         dateReturn=None,
#     ):
#         self.__serviceList.createItem(
#             code, kindService, count, client, dateReception, dateReturn
#         )
...
#     def getKindServiceList(self):
#         return self.__kindServiceList.getItems()

#     def getKindServiceCodes(self):
...
#                     if t[0] == "count":
#                         count = int(t[1])
#                     if t[0] == "dateReception":
#                         dateReception = t[1]
#                     if t[0] == "dateReturn":
#                         dateReturn = t[1]
#                     if t[0] == "client":
#                         client = self.getRas().getClient(int(t[1]))
#                     if t[0] == "kindService":
#                         kindService = self.getRas().getKindService(int(t[1]))
#                 self.getRas().createService(
#                     code, kindService, count, client, dateReception, dateReturn
#                 )
...
#         data = curs.fetchall()
#         for r in data:
#             self.getRas().createClient(r[0], r[1], r[2], r[3])
#         curs.execute("select code,name,typeservice,price from kindService")
#         data = curs.fetchall()
#         for r in data:
#             self.getRas().createKindService(r[0], r[1], r[2], r[3])
#         curs.execute(
#             "select code,kindService,count,client,dateReception,dateReturn from Service"
#         )
#         data = curs.fetchall()
#         for r in data:
#             self.getRas().createService(
#                 r[0],
#                 self.getRas().getKindService(int(r[1])),
#                 r[2],
#                 self.getRas().getClient(int(r[3])),
#                 r[4],
#                 r[5],
#             )
#         conn.close()
...
#         for a in self.getRas().getClientList():
#             curs.execute(
#                 "insert into client(code,surname,name,secname,regular) values('%s','%s','%s','%s','%s')"
#                 % (
#                     a.getCode(),
#                     a.getSurname(),
#                     a.getName(),
...
#         for p in self.getRas().getKindServiceList():
#             curs.execute(
#                 "insert into kindService(code,name,typeservice,price) values('%s','%s','%s','%s')"
#                 % (p.getCode(), p.getName(), p.getTypeService(), p.getPrice())
#             )
#         for b in self.getRas().getServiceList():
#             curs.execute(
#                 "insert into service(code,kindService,count,client,dateReception,dateReturn) values('%s','%s','%s','%s','%s','%s')"
#                 % (
#                     b.getCode(),
#                     str(b.getKindService().getCode()),
#                     b.getCount(),
#                     str(b.getClient().getCode()),
#                     str(b.getDateReception()),
#                     str(b.getDateReturn()),
#                 )
#             )
#         conn.commit()
...
# dat1 = dataxml(
#     ras1,
#     r"C:\python\source\repos\PythonApplication\oldfile.xml",
#     r"C:\python\source\repos\PythonApplication\newfile.xml",
# )
# dat2 = dataxml(
#     ras2,
#     r"C:\python\source\repos\PythonApplication\oldfile.xml",
